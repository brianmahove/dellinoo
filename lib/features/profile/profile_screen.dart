    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _OrderShortcut(IconlyLight.bag_2, 'Processing', count((o) => o.status == OrderStatus.processing)),
                    _OrderShortcut(
          ...
          _Group([
            _Item(IconlyLight.chat, 'Chat with us on WhatsApp', () => soon('WhatsApp chat')),
...
class _Item extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      trailing: danger ? null : const Icon(IconlyLight.arrow_right_2, color: AppColors.muted),
    );
  }
}
